...
// Webshop-getads: GetAds - returns 2 random advertisements
...
module.exports = async (request, context) => {
    ...
    console.log("GetAds: Event:", body);
    const picked = ADS.slice().sort(() => 0.5 - Math.random()).slice(0, 2);
    return context.status(200).succeed(picked);
};
