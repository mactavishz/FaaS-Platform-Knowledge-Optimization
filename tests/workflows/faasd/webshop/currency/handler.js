...
// Webshop-currency: Currency - converts a monetary amount between two currencies
// Express-style handler (req, res)

// EUR-based exchange rates (from BeFaaS webshop reference)
const EUR_RATES = {
    EUR: 1.0,
    CAD: 1.5231,
    HKD: 8.3693,
...
module.exports = async (request, context) => {
    ...
    return context.status(200).succeed({ units: convUnits, nanos: convNanos, currencyCode: event.toCode });
};
