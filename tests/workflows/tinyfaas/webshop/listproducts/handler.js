// Webshop-listproducts: ListProducts - returns the hardcoded product catalogue
...
const PRODUCTS = [
    ...
    },
    {
        ...
        priceUsd: { currencyCode: "USD", units: 14, nanos: 990000000 },
    ...
    },
    {
        ...
        priceUsd: { currencyCode: "USD", units: 34, nanos: 990000000 },
    ...
    },
    {
        ...
        priceUsd: { currencyCode: "USD", units: 44, nanos: 990000000 },
        categories: ["electronics", "computers"],
    },
    {
        id: "5",
        ...
        picture: "monitor.jpg",
        priceUsd: { currencyCode: "USD", units: 64, nanos: 990000000 },
        categories: ["electronics", "computers"],
    },
    {
        id: "6",
        ...
        priceUsd: { currencyCode: "USD", units: 74, nanos: 990000000 },
        categories: ["electronics", "computers"],
    },
    {
        id: "7",
        ...
        priceUsd: { currencyCode: "USD", units: 84, nanos: 990000000 },
        categories: ["electronics", "computers"],
    },
    {
        id: "8",
        ...
        priceUsd: { currencyCode: "USD", units: 39, nanos: 990000000 },
        categories: ["clothing", "programming"],
    },
    {
        id: "9",
        ...
        priceUsd: { currencyCode: "USD", units: 29, nanos: 990000000 },
        categories: ["clothing", "programming"],
    },
    {
        id: "10",
    ...
    },
    {
        ...
        priceUsd: { currencyCode: "USD", units: 12, nanos: 990000000 },
        categories: ["kitchen", "programming"],
    },
];

export default async (req, res) => {
    console.log("ListProducts: Event:", req.body);
